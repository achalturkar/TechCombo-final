  ...
  return (
    <div className="bg-gradient-to-r from-green-300 p-4 md:p-16 border-lg w-full flex flex-col md:flex-row md:justify-center md:items-center gap-8">
      ...
      "Achievements That Define Us"
              ...
              <br />
        <h2 className="text-5xl font-poppins font-bold flex justify-center md:justify-start items-center gap-2 text-blue-600">
      ...
      <div className="w-full md:w-1/2 flex flex-col gap-8">
        <div className="flex items-center">
          ...
          <div className="pl-6">
            <h2 className="text-5xl font-poppins font-bold flex items-center gap-2 text-blue-600">
