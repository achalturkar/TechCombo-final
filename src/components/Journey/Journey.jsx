...
const Journey = () => {
    ...
    const journeyData = [
        { year: "2020 - The Beginning", text: "Established with a focus on IT staffing and solutions, aiming to deliver efficient and reliable services.", image: "/src/assets/img/1.jpg" },
